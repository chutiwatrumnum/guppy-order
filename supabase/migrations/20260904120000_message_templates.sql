...
('list_empty', 'ไม่มีพัสดุที่ติดตาม', 'ตอบเมื่อกด "พัสดุของฉัน" แล้วยังไม่มีอะไร', 'chat',
 E'📭 ตอนนี้ยังไม่มีพัสดุที่กำลังตามอยู่ครับ\nพอร้านส่งของ ระบบจะขึ้นให้เองอัตโนมัติ',
 array[]::text[], array[]::text[], 80),

('list_header', 'หัวข้อพัสดุของฉัน', 'บรรทัดบนสุดก่อนรายการพัสดุ', 'chat',
 E'📦 พัสดุที่กำลังติดตาม:',
 array[]::text[], array[]::text[], 90),

('list_footer', 'ท้ายพัสดุของฉัน', 'บรรทัดล่างสุดหลังรายการพัสดุ', 'chat',
