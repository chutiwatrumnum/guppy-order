...
export interface Breed {
  ...
  // ── ของหน้าเว็บฟาร์ม (/farm) เท่านั้น ไม่เกี่ยวกับการคีย์บิล ──
  /** รูปปลาจริง ว่างไว้ได้ หน้าเว็บจะวาดปลาการ์ตูนจากชื่อพันธุ์ให้แทน */
  image_url?: string | null;
  /** คำโปรยสั้น ๆ ใต้ชื่อพันธุ์ */
  blurb?: string | null;
  /** ให้ขึ้นหน้าเว็บไหม — พันธุ์ที่เลิกขายแล้วติ๊กออกได้โดยไม่ต้องลบทิ้ง */
  showcase?: boolean;
  /** ตอนนี้สั่งได้ไหม — สวิตช์ล้วน ๆ ร้านไม่ได้นับจำนวนสต็อก */
  in_stock?: boolean;
}
